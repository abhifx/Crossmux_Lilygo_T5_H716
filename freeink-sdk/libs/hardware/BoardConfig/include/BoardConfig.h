...
#endif
#ifndef FREEINK_DRIVER_EPD_PAINTER
#define FREEINK_DRIVER_EPD_PAINTER 0
#endif
// LilyGo T5 S3 and M5Stack PaperS3: raw-parallel ED047TC1 via LovyanGFX (M5GFX) or EPD_Painter.
#if FREEINK_DRIVER_EPD_PAINTER
#define FREEINK_DRIVER_LGFX_EPD 0
#elif FREEINK_DEVICE_LILYGO || FREEINK_DEVICE_PAPERS3
...
constexpr TouchConfig LILYGO_T5_H715_GT911 = {
    TouchController::Gt911, 18, 17, 47, 9, 0x5D, 0, 959, 0, 539, false, 0x14, false, true,
    PIN_UNASSIGNED, true, false, true, false};

constexpr BoardProfile LILYGO_T5_H715 = {
    Board::LilyGoT5H715,
    "lilygo_t5_h715",
    InputStyle::DigitalButtons,
    DisplayController::EpdPainter,
    960,
    540,
    {PIN_UNASSIGNED, PIN_UNASSIGNED, PIN_UNASSIGNED, PIN_UNASSIGNED, PIN_UNASSIGNED, PIN_UNASSIGNED,
     PIN_UNASSIGNED},
    0,
    {11, 16, 15, 42, PIN_UNASSIGNED, false, 0},  // SD over SPI: SCLK11 MISO16 MOSI15 CS42
    {PIN_UNASSIGNED, 21, PIN_UNASSIGNED, PIN_UNASSIGNED, PIN_UNASSIGNED, PIN_UNASSIGNED, 0,
     false},         // power=GPIO21, active-low
    14,              // batteryAdc: GPIO14
    PIN_UNASSIGNED,
    2.0f,
    PIN_UNASSIGNED,
    LILYGO_T5_H715_GT911,
    NO_FRONTLIGHT,
    NO_AUDIO,
    NO_LEDS,
    NO_FLIP,
...
#if FREEINK_DRIVER_EPD_PAINTER
constexpr BoardProfile DEFAULT_DEVICE = LILYGO_T5_H715;
#else
...
inline bool selectDevice(Board which) {
  switch (which) {
    ...
    case Board::LilyGoT5S3:
      ACTIVE = LILYGO_T5S3;
      break;
    case Board::LilyGoT5H715:
      ACTIVE = LILYGO_T5_H715;
      break;
#endif
#if FREEINK_DEVICE_M5PAPER
