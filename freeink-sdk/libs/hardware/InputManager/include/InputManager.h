...
class InputManager {
 ...
 private:
  ...
  static constexpr int TOUCH_SWIPE_MIN_PX = 32;
  ...
  static_assert(TOUCH_TAP_RELEASE_SLOP_PX == 31);
  static_assert(TOUCH_SWIPE_MIN_PX == 32);
  static constexpr unsigned long TOUCH_SWIPE_MAX_MS = 1000;
