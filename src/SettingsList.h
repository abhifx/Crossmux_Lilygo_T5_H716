...
inline const std::vector<SettingInfo>& getBaseSettingsList() {
  static const std::vector<SettingInfo> baseList = [] {
    ...
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_COLOR_DEPTH, &CrossPointSettings::colorDepth,
                          {StrId::STR_1_BIT, StrId::STR_2_BIT, StrId::STR_4_BIT}, "colorDepth",
                          StrId::STR_CAT_DISPLAY),
        SettingInfo::Enum(StrId::STR_IMAGES, &CrossPointSettings::ditherMode,
                          {StrId::STR_NONE_OPT, StrId::STR_BAYER_4X4, StrId::STR_BAYER_8X8}, "ditherMode",
                          StrId::STR_CAT_DISPLAY),
        SettingInfo::Enum(StrId::STR_UI_THEME, &CrossPointSettings::uiTheme,
                          {StrId::STR_THEME_CLASSIC, StrId::STR_THEME_LYRA, StrId::STR_THEME_LYRA_EXTENDED,
                           StrId::STR_THEME_ROUNDEDRAFF, StrId::STR_THEME_LYRA_CAROUSEL, StrId::STR_THEME_INX, StrId::STR_THEME_SHELF},
