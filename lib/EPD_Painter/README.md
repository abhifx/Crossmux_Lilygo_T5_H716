...
| `drawGray8()` | Draw an 8bpp greyscale image, Floyd-Steinberg dithered against the panel's measured level curve |
| `drawGray8Fit()` | As above, scaled to fit the canvas and centred — the photo case |
